<template>
  <el-drawer v-model="drawerVisible" title="布局设置" size="290px">
    <el-divider class="ct-divider" content-position="center">
      <el-icon><Notification /></el-icon>
      布局样式
    </el-divider>

    <div class="ct-layout-box">
      <el-tooltip effect="dark" content="纵向" placement="top" :show-after="200">
        <div
          :class="[
            'ct-layout-item layout-vertical',
      ...
      <el-tooltip effect="dark" content="经典" placement="top" :show-after="200">
        <div
          :class="['ct-layout-item layout-classic', { 'is-active': layout == 'classic' }]"
...
<script setup lange="ts" name="ThemeDrawer">
import { ref } from "vue";
...
const setLayout = (val) => {
  console.log(val);
  globalStore.updateGlobalState("layout", val);
  setAsideTheme();
};
</script>
